...
// 设置优选地址api接口
let addressesapi = [
	'https://cf-workers-text2kv-cv9.pages.dev/ip.txt?token=hong0328', //可参考内容格式 自行搭建。
	'https://cf-workers-text2kv-cv9.pages.dev/result.csv?token=hong0328', //IPv6优选内容格式 自行搭建。
];
